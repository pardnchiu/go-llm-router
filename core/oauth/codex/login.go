...
func LoginWithCallback(ctx context.Context, onURL func(string)) (*llmrouter.CodexToken, error) {
	b := make([]byte, 32)
	_, err := rand.Read(b)
	if err != nil {
...
func exchangeCode(ctx context.Context, code, verifier, redirect string) (*llmrouter.CodexToken, error) {
	form := url.Values{
