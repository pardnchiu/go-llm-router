...
func Load() (*llmrouter.GrokToken, error) {
...
func EnsureFresh(ctx context.Context, token *llmrouter.GrokToken) (*llmrouter.GrokToken, error) {
...
func saveToken(t *llmrouter.GrokToken) error {
